...
export default function Home(): JSX.Element {
  return (
    <main className="w-full min-h-screen flex flex-col gap-10 relative overflow-x-clip mt-[50px]">
      <div className="-z-10 absolute -right-[40%] -top-[25%] w-[1550px] h-[1550px] [background:radial-gradient(closest-side,#a704ffa3,transparent)]" />
      <div className="-z-10 absolute -left-[40%] -top-[40%] w-[1550px] h-[1550px] [background:radial-gradient(closest-side,#ff0492a3,transparent)]" />
      ...
      <section className="w-full h-auto container flex flex-col justify-center items-center font-poppins mt-[50px] gap-5">
